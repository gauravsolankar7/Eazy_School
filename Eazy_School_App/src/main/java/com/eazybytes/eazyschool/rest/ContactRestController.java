...
public class ContactRestController {
    ...
    @PostMapping("/saveMsg")
    // @ResponseBody
    public ResponseEntity<Response> saveMsg(@RequestHeader String invocationFrom,
                                            @Valid @RequestBody Contact contact){
        log.info("Header invocationFrom = %s".formatted(invocationFrom));
    ...
    public ResponseEntity<Response> deleteMsg(RequestEntity<Contact> requestEntity){
        ...
        headers.forEach((key, value) -> {
            log.info("Header '%s' = %s".formatted(key, value.stream().collect(Collectors.joining("|"))));
