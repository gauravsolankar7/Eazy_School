...
public class AdminController {
    ...
    public ModelAndView addNewClass(Model model, @ModelAttribute EazyClass eazyClass) {
    ...
    public ModelAndView addStudent(Model model, @ModelAttribute Person person, HttpSession session) {
    ...
    public ModelAndView addNewCourse(Model model, @ModelAttribute Courses course) {
        ModelAndView modelAndView = new ModelAndView();
    ...
    public ModelAndView addStudentToCourse(Model model, @ModelAttribute Person person,
                                           HttpSession session) {
        ModelAndView modelAndView = new ModelAndView();
